...
export default function EditTransactionPage() {
  ...
  const { getById, update } = useTransactions();
    ...
    const loadTransaction = async () => {
      ...
      try {
        ...
        if (result) {
          ...
          setGeneralError("Transaction introuvable");
        }
      } catch {
        setGeneralError("Erreur lors du chargement");
      } finally {
        setIsLoading(false);
      }
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result) {
        ...
        setGeneralError("Erreur lors de la mise à jour");
      }
    } catch (err: any) {
      setGeneralError(
