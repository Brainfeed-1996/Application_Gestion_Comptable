...
import type { Invoice, InvoiceCreate, InvoiceLine } from '@/types/invoice';
...
export async function getInvoices(params?: {
  ...
  return apiClient.get<{ items: Invoice[]; total: number; page: number; limit: number; totalPages: number }>(
